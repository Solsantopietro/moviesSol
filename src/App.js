            ...
            <>
              <BrowserRouter>
                ...
                <Switch>
                  ...
                  <Route exact path="/movie/:category" component={CategorySection} />
                  <Route exact path="/tv/:category" component={CategorySection} />
                  ...
                  <Route exact path="/multi/:name/page/:page" component={BusquedaMedia} />
